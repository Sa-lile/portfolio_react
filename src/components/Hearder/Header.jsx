    ...
    <div className='header flex flex-col' id='header'>
      ...
      <div className='container flex'>
        <div className='header-content'>
            ...
            <h3 className='text-grey fw-6'>En quête d'amélioration continue, je poursuis des études autonomes Python (en utilisant Streamlit et JupyterLab) et Java/Angular. Parallèlement, je travaille actuellement sur la création d'un site de vente en utilisant React.</h3>
